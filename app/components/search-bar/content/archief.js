...
export default class SearchBarContentArchiefComponent extends Component {
    @tracked selected;
    @tracked eenheids;
    @service searchBar;
    ...
    get get_Search(){
      if(!this.searchBar.gemeente_search){
        ...
        this.eenheids = null;//  console.log(this.gemeente_search);
    ...
    ?o_voorstander a <http://data.vlaanderen.be/ns/mandaat#Fractie>.
    ...
    ?o_tegenstander a <http://data.vlaanderen.be/ns/mandaat#Fractie>.
    ...
    ?o_onthouder a <http://data.vlaanderen.be/ns/mandaat#Fractie>.
    ...
    getData.then( results => {
      ...
      const descripttion = l.description;
